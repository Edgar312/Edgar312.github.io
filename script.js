  ...
  if (isMobile) {
    ...
    rightContent.innerHTML = `
      <div class="mobile-wrapper">
        <h2>${item.title}</h2>
        ${id === 'about' ? `<img src="${item.images[0]}" class="profile-img" onerror="this.src='https://via.placeholder.com/150'">` : ''}
        <p>${item.text}</p>
        <div class="img-grid">
    ...
    if (id === 'about') {
      ...
      `;
      rightContent.innerHTML = `
        <p style="margin-top: 100px; font-style: italic; opacity: 0.5; padding: 40px;">
          "I build solutions that combine software, systems thinking, and real-world usability. I enjoy taking ownership of projects from concept to deployment, handling architecture, design, and implementation."
        </p>
      `;
    } else if (id === 'animal') {
      leftContent.innerHTML = `
